...
def main():
    ...
    for episode in range(EPISODE):
        ...
        # calculate features
        sample_features = samples.view(CLASS_NUM, SAMPLE_NUM_PER_CLASS, Feature_D).cuda(GPU)  # w*s*1000
        ...
        loss =  loss_vector+loss_triplet + loss_proto
        # print(task_norm.norm.weight)
        # print('%%%%%%')
